...
data class VI(val id:String,val tt:String,val pt:String,val sc:String,val ut:String) // 视频列表简略项（id/tt=标题/pt=封面/sc=评分/ut=更新状态）
...
suspend fun fS(id:String,vid:String):String= withContext(Dispatchers.IO){ // 解析单集播放直链：优先返回免费源，无则返回第一个非空源
	runCatching{
