...
suspend fun fD(id:String):VD?= withContext(Dispatchers.IO){ // fD (fetchDetail) 深度拉取正片详情全量包
	runCatching{
		...
		VD(ep=us,et=ts,id=id,tt=o.optString("title",""),ds=o.optString("introduce",""),pt=o.optString("coverImgUrl","")+"?width=500&height=283&scale=both&mode=crop&anchor=topcenter&format=jpg")
